  ...
  return (
    <div>
      ...
      <p>
        ...
        .md et en respectant les règles de markdown. L'article sera ensuite
      ...
      <br />
      <p>
        Attention ! Le contenu mis en ligne par le rédacteur est SA propriété,
        mais en soumettant son contenu à la plateforme, il s'engage à ce que le
        contenu vienne de lui et non d'une plateforme concurrente. Creative
        Blogger et ses administrateurs ne pourront pas être tenus responsable si
        le contenu publié est le même que celui d'une autre plateforme, seul le
        rédacteur qui a posté ce contenu peut être tenu responsable de cet acte.
      </p>{" "}
      <br />
      <p>
