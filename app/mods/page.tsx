  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          Ils peuvent infliger des sanctions aux utilisateurs ne respectant pas
          le règlement. Toutes sanctions peut être contesté par mail et les
          administrateurs donneront leurs avis final qui ne pourra être contesté
          par l'utilisateur.
        </li>
      </ul>
      <br />
      ...
      <ul>
        ...
        <li>
          Le refus d'un article écrit par un rédacteur pour ses propres intêrets
        </li>
      </ul>
      <br />
      <p>
